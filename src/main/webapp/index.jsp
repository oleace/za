...
<div class="navboxindex">
    <ul class="navindex">
        ...
        <%--<li><a href="${path}/cms/magazineArticle/index">杂志文章</a></li>--%>
...
<div class="navboxindex">
    <ul class="navindex">
        <%--<li><a href="">设备管理</a></li>--%>
            ...
            <li><a href="${path}/cms/magazines/index">杂志管理</a></li>
            <li><a href="${path}/cms/albums/index">音乐专栏</a></li>
            <li><a href="${path}/cms/music/index">音乐管理</a></li>

        <%--<li><a href="${path}/cms/release/index">发布包管理</a></li>--%>
        <%--<li><a href="${path}/cms/cc/index">分类首页</a></li>--%>
    </ul>
</div>
<%--<div class="navboxindex">--%>
    <%--<ul class="navindex">--%>
        <%--<li><a href="${path}/cms/mall/index">商城管理</a></li>--%>
    <%--</ul>--%>
<%--</div>--%>
<div class="navboxindex">
    <ul class="navindex">
        <li><a href="${path}/cms/vote/index">投票管理</a></li>
        <li><a href="${path}/cms/questionnaire/index">问卷管理</a></li>
        <%--<li><a href="${path}/das/vaq/index">投票/问卷</a></li>--%>
        <li><a href="${path}/das/advice/index">用户反馈</a></li>
    </ul>
</div>
<%--<div class="navboxindex">--%>
    <%--<ul class="navindex">--%>
