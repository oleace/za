    ...
    window.UEDITOR_CONFIG = {
        ...
        , toolbars: [
            ['fullscreen', 'source', '|', 'undo', 'redo', '|',
                ...
                'insertimage', 'emotion', 'scrawl', 'insertvideo', 'music', 'map', 'insertframe', 'pagebreak', 'template', 'background', '|',
